...
n = 5
# Two tetrahedra sharing a triangle ridge {0,1,2}: {0,1,2,3} and {0,1,2,4}
...
print("edges of F:", [sorted(e) for e in edges])
...
for q in [2,3,5]:
    ...
    for e in edges:
        ...
        print(f"  e={sorted(e)}: chi(Delta/e) = {chi_con.factor()}   [diff == -(q-1)^3 * chi_con ? {ratio_ok}]")
